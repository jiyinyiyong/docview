...
make_array = function(arr) {
  var code_line, empty_line, item, last_index, line, output_array, scope_lines, space, stack, _i, _j, _k, _len, _len1, _len2;
  scope_lines = [];
  ...
  output_array = [];
  for (_j = 0, _len1 = scope_lines.length; _j < _len1; _j++) {
    item = scope_lines[_j];
